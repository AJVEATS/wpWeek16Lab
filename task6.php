...
<body>
    ...
    <section id="updateProduct">
        <div>
            ...
            <form action="task6.php" method="POST">
                <label>Enter the name of the product that you want to update:</label>
                <input type="text" name="editProductName" value="Product"><br>
                <label>Enter the updated description of the product:</label>
                <input type="text" name="editProductDescription" value="Product description"><br>
                <label>Enter the updated price of the product</label>
                <input type="text" name="editProductPrice" value="£00.00"><br>
                <label>Enter the updated cost price of the products</label>
                <input type="text" name="editProductCostPrice" value="£00.00"><br>
        ...
        <?php
            ...
            $editProductCostPrice = $_POST['editProductCostPrice'];
